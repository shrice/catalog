...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__66291 = cljs.core.instance_QMARK_;
var expr__66292 = reactive_val;
if(cljs.core.truth_(pred__66291.call(null,reagent.ratom.RAtom,expr__66292))){
return "ra";
} else {
if(cljs.core.truth_(pred__66291.call(null,reagent.ratom.RCursor,expr__66292))){
return "rc";
} else {
if(cljs.core.truth_(pred__66291.call(null,reagent.ratom.Reaction,expr__66292))){
return "rx";
} else {
if(cljs.core.truth_(pred__66291.call(null,reagent.ratom.Track,expr__66292))){
return "tr";
} else {
return "other";
}
