...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__20723__auto__,writer__20724__auto__,opt__20725__auto__){
return cljs.core._write.call(null,writer__20724__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__66134 = o;
(G__66134[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__66135__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__66135 = function (var_args){
var args = null;
...
return G__66135__delegate.call(this,args);};
G__66135.cljs$lang$maxFixedArity = 0;
G__66135.cljs$lang$applyTo = (function (arglist__66137){
var args = cljs.core.seq(arglist__66137);
return G__66135__delegate(args);
});
G__66135.cljs$core$IFn$_invoke$arity$variadic = G__66135__delegate;
return G__66135;
})()
;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__66139){
var map__66140 = p__66139;
var map__66140__$1 = ((((!((map__66140 == null)))?((((map__66140.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__66140.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__66140):map__66140);
var props = map__66140__$1;
var class$ = cljs.core.get.call(null,map__66140__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__66142){
...
var on_write = cljs.core.get.call(null,map__66143__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__66143,map__66143__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__66143,map__66143__$1,on_write))
);
} else {
...
reagent.impl.template.input_render_setup.cljs$core$IFn$_invoke$arity$3 = (function (this$,jsprops,p__66148){
...
var synthetic_on_update = cljs.core.get.call(null,map__66149__$1,new cljs.core.Keyword(null,"synthetic-on-update","synthetic-on-update",1615571932));
var synthetic_on_change = cljs.core.get.call(null,map__66149__$1,new cljs.core.Keyword(null,"synthetic-on-change","synthetic-on-change",-2073813537));
if(cljs.core.truth_((function (){var and__19294__auto__ = !((jsprops == null));
if(and__19294__auto__){
var and__19294__auto____$1 = jsprops.hasOwnProperty("onChange");
if(cljs.core.truth_(and__19294__auto____$1)){
return jsprops.hasOwnProperty("value");
} else {
return and__19294__auto____$1;
}
} else {
...
var G__66151 = jsprops;
(G__66151["defaultValue"] = value);

(G__66151["onChange"] = ((function (G__66151,v,value,on_change,on_change__$1,map__66149,map__66149__$1,synthetic_on_update,synthetic_on_change){
return (function (p1__66145_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change__$1,p1__66145_SHARP_);
});})(G__66151,v,value,on_change,on_change__$1,map__66149,map__66149__$1,synthetic_on_update,synthetic_on_change))
);
...
var vec__66155 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__66155,(0),null);
var id = cljs.core.nth.call(null,vec__66155,(1),null);
var class$ = cljs.core.nth.call(null,vec__66155,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___66159 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___66159 == null)){
} else {
var key_66160 = temp__5461__auto___66159;
(jsprops["key"] = key_66160);
}
...
reagent.impl.template.adapt_react_class.cljs$core$IFn$_invoke$arity$2 = (function (c,p__66163){
var map__66164 = p__66163;
var map__66164__$1 = ((((!((map__66164 == null)))?((((map__66164.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__66164.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__66164):map__66164);
var synthetic_input = cljs.core.get.call(null,map__66164__$1,new cljs.core.Keyword(null,"synthetic-input","synthetic-input",-135147697));
...
var wrapped = (function (){var G__66166 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__66166["name"] = c);
...
var wrapped__$1 = (cljs.core.truth_(synthetic_input)?(function (){var G__66167 = wrapped;
(G__66167["syntheticInput"] = true);

return G__66167;
})():wrapped);
var wrapped__$2 = (cljs.core.truth_(synthetic_input)?(function (){var G__66168 = wrapped__$1;
(G__66168["syntheticOnChange"] = on_change);

return G__66168;
})():wrapped__$1);
var wrapped__$3 = (cljs.core.truth_(synthetic_input)?(function (){var G__66169 = wrapped__$2;
(G__66169["syntheticOnUpdate"] = on_update);
...
if(cljs.core.truth_((function (){var or__19323__auto__ = synthetic_input;
...
var len__21975__auto___66175 = arguments.length;
var i__21976__auto___66176 = (0);
while(true){
if((i__21976__auto___66176 < len__21975__auto___66175)){
args__21982__auto__.push((arguments[i__21976__auto___66176]));

var G__66177 = (i__21976__auto___66176 + (1));
i__21976__auto___66176 = G__66177;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__21983__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq66173){
var G__66174 = cljs.core.first.call(null,seq66173);
var seq66173__$1 = cljs.core.next.call(null,seq66173);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__66174,seq66173__$1);
});
...
break;
default:
var G__66180 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__66180;
continue;
...
var n__21540__auto___66182 = a.length;
var i_66183 = (0);
while(true){
if((i_66183 < n__21540__auto___66182)){
(a[i_66183] = reagent.impl.template.as_element.call(null,(a[i_66183])));

var G__66184 = (i_66183 + (1));
i_66183 = G__66184;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__21540__auto___66185 = a.length;
var i_66186 = (0);
while(true){
if((i_66186 < n__21540__auto___66185)){
var val_66187 = (a[i_66186]);
if((cljs.core.vector_QMARK_.call(null,val_66187)) && ((reagent.impl.template.key_from_vec.call(null,val_66187) == null))){
(o["no-key"] = true);
} else {
}

(a[i_66186] = reagent.impl.template.as_element.call(null,val_66187));

var G__66188 = (i_66186 + (1));
i_66186 = G__66188;
continue;
} else {
}
...
var ctx = ({});
var vec__66189 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__66189,(0),null);
var derefed = cljs.core.nth.call(null,vec__66189,(1),null);
...
var G__66192 = (cljs.core.count.call(null,argv) - first_child);
switch (G__66192) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__66192){
